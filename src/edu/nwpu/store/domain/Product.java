...
public class Product {
	...
	private double shop_price; // 商品图片路径
	private String pimage; // 商品上架日期
	private Date pdate; // 商品是否热门
	private int is_hot; // 商品描述
	private String pdesc; // 商品是否在货架上 0：在货架上 | 1：不在货架上
	private int pflag; // 商品所在分类id
